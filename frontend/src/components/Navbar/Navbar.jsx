...
import RadixNavigationMenu from "./radixDropDown/radixDropDown";
import { useNavigate } from "react-router-dom";
import { Link } from "react-router-dom";
import { BasicRoutes } from "./NavigationRoutes";
            ...
            <div className='relative flex h-16 items-center justify-between'>
              ...
              <div className='absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0'>
                ...
                {/* Profile dropdown */}
                  ...
                  <div>
                    <button
                    onClick={()=> faffyDuckCookie? Navigate('/update-page'): Navigate('/login')}
                     className='flex rounded-full text-md text-white p-2 px-5 bg-[#a4acf4] hover:bg-[#6c64f8] '>
                      <p>{faffyDuckCookie? 'Update': 'Login'}</p>
